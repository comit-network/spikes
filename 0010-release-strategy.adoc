...
** We may consider doing version check-ing as part of cnd start up by ending an endpoint on btsieve side that expose the version and checking at cnd start that a compatible version of btsieve is used;
