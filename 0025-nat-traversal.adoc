...
- - Opens up the user to security vulnerabilities arising from the NAT blindly trusting applications and allowing incoming traffic to connect to externally facing ports
