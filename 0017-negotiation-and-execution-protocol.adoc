...
* Bid: The amount of asset the maker _offers_ (or _sells_).
...
The message from the maker to the taker that specifies a specific offer to be executed. The parameters are defined <<negotiation-output-paramaters, this table>>.
