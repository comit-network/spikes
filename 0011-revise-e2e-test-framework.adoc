...
1. Each tests sets up its own dependencies (cnd, btsieve, blockchain nodes)
...
- our software should allow us to use it in parallel (swaps are independent from other)
